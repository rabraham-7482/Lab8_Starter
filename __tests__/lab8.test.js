...
describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    let innerText = await shadow_button.getProperty('innerText')
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    let cart_count = await page.$("#cart-count");
    let cart_count_innerText = await cart_count.getProperty('innerText');
    let cart_count_text = await cart_count_innerText.jsonValue();
